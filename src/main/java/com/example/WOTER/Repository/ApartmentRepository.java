...
@Repository
public interface ApartmentRepository  extends JpaRepository<SaldoEntity, Long>{
        @Query(value = """          
                       ...
                       where wc.system_id = 1
                        ...
                        order by id
            """, nativeQuery = true)
        List<Object[]> findApartment(@Param("month") Integer month, @Param("year") Integer year);
